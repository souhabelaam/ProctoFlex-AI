@echo off
echo 🚀 ProctoFlex AI - Démarrage de l'Application Desktop
echo ======================================================
echo.
...
REM Aller dans le répertoire desktop
cd desktop

REM Vérifier si le répertoire desktop existe
if not exist "package.json" (
    echo ❌ Répertoire desktop non trouvé ou package.json manquant
    echo 💡 Assurez-vous d'être dans le bon répertoire
    pause
    exit /b 1
)

echo ✅ Répertoire desktop trouvé
